...
import android.widget.ListView;
    ...
    public class LocalAdministradoMenuActivity extends ListActivity {
        ...
        String[] activities={"LocalAdministradoInsertarActivity","LocalAdministradoConsultarActivity","LocalAdministradoActualizarActivity", "LocalAdministradoEliminarActivity"};
        @Override
