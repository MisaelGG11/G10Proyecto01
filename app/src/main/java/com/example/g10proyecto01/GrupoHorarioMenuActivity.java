...
public class GrupoHorarioMenuActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        l.getChildAt(position).setBackgroundColor(Color.parseColor("#85C1E9"));
