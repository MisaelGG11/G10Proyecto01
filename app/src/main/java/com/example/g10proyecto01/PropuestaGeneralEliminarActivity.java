...
public class PropuestaGeneralEliminarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_propuesta_general_eliminar);
        helper = new ControlG10Proyecto01(this);
        llenarSpinnerPropuestaGeneral();
    }
    public void llenarSpinnerPropuestaGeneral(){
        spinIdPropuesta = findViewById(R.id.spinEliminarPropuestaGeneral);
    ...
    public void EliminarPropuestaGeneral(View v){
        AlertDialog.Builder alerta = new AlertDialog.Builder(PropuestaGeneralEliminarActivity.this);
        ...
        alerta.setPositiveButton("Sí", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                int idPropuesta = Integer.parseInt(spinIdPropuesta.getSelectedItem().toString());
                PropuestaGeneral propuestaGeneral = new PropuestaGeneral(idPropuesta);
                helper.abrir();
                regEliminadas=helper.eliminar(propuestaGeneral);
                helper.cerrar();
                Toast.makeText(PropuestaGeneralEliminarActivity.this, regEliminadas, Toast.LENGTH_SHORT).show();
            }
        });
